                ...
                {loading ? <LoadingBlock /> : (
                  <>
                    ...
                    <div className="official-bank-card">
                      <span className="official-bank-name">{settings.bank_name || '—'}</span>
                      <strong className="official-account-name">{settings.account_name || '—'}</strong>
                      <div className="official-account-number-row">
                        <code>{settings.account_number || '—'}</code>
                        <button type="button" onClick={() => void copyAccount()} aria-label={t('Salin nombor akaun', 'Copy account number')} title={t('Salin nombor akaun', 'Copy account number')}>
